       ...
       //     StartFireBaseServices();
        ...
        public void ProcModelosNosLogs()
        {
            try
            {
                ...
                //ION A80i
                string modeloA80i = "A80i";
                string filePathA80i = @"C:\TESTES_AVELL\systemInfo\sistema.txt";
                StreamReader readerA80i = new StreamReader(filePathA80i);

                while (!readerA80i.EndOfStream)
                {
                    string lineA80i = readerA80i.ReadLine();
                    if (lineA80i.Contains("Modelo do sistema:") && lineA80i.Contains(modeloA80i))
                    {
                        TECLADO = "OK";
                        TECLADO2 formTeclado2 = new TECLADO2();
                        this.Hide();
