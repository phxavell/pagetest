    ...
    //        StartFireBaseServices();
        ...
        public void ClickBurnin_W11()
        {
            ...
            foreach (ManagementObject filtroPorBios in osDetailsCollection)
            {
                ...
                if (selecaoVersao == "N.1.09AVE02")
                {
                    lblModelo.Text = "STORM GO/ION-A80i";
                    Validado = "OK";
                    Coordenadas6_W11();
                }
                ...
                if (selecaoVersao == "N.1.09AVE03")
                {
                    lblModelo.Text = "ION A65I";
                    Validado = "OK";
                    Coordenadas6_W11();
                }


                if (selecaoVersao != "N.1.09AVE03" && selecaoVersao != "1.07.11TBN1" && selecaoVersao != "N.1.10AVE03" && selecaoVersao != "N.1.05AVE04" &&
